...
subscription operation. Other types of operations, like queries and mutations, are possible but their use here is less
appealing because of the transport overhead compared to the plain JSON over HTTP variant.
